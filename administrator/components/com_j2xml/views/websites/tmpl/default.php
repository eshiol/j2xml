...
?>
<form
	action="<?php echo JRoute::_('index.php?option=com_j2xml&view=websites'); ?>"
		...
		<div id="filter-bar" class="btn-toolbar">
				<div class="filter-search btn-group pull-left">
					...
					<input type="text" name="filter_search" id="filter_search"
						placeholder="<?php echo JText::_('COM_J2XML_SEARCH_IN_TITLE'); ?>"
						value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
						title="<?php echo JText::_('COM_J2XML_SEARCH_IN_TITLE'); ?>" />
				</div>
	...
	:
		...
		?>
				<tr class="row<?php echo $i % 2; ?>">
						...
						<?php endif; ?>
						<span
							class="icon-<?php echo ($item->type ? 'key' : 'user'); ?><?php
		...
		?>"></span>
						<?php if ($canEdit) : ?>
							<a
							href="<?php echo JRoute::_('index.php?option=com_j2xml&task=website.edit&id='.(int) $item->id); ?>"><?php echo $this->escape($item->title); ?></a>
						<?php else : ?>
								<?php echo $this->escape($item->title); ?>
						<?php endif; ?>
						<?php if (isset($item->expire_time)): ?>
						<p class="smallsub">
								(<span>expire time</span>: <?php echo $item->expire_time; ?>)</p>
						<?php endif; ?>
					</td>
						<td>
	...
	:
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
					...
					<?php if ($canEdit) : ?>
						<a
								href="<?php echo JRoute::_('index.php?option=com_j2xml&task=website.edit&id='.(int) $item->id); ?>">
